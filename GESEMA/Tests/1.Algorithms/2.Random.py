...
class Mapping:
	...
	def __init__(self, request, execution, mode):
	...
	def execute(self):
		...
		evaluations = self.__algorithm.execute(self.__execution, self.__mode)
		return evaluations
...
if len(sys.argv) < 4 or len(sys.argv) > 6:
	...
	print("-> *.py file_name (-r nr_rounds | -t time_secs) [-o output_name]")
	print("==========================================================")
	exit()
